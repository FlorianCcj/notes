...
\input{src/frames-shell/shell.tex}
\input{src/frames-shell/bash-files.tex}
\input{src/frames-shell/bash-scripting.tex}
\input{src/frames-shell/bash-parameters.tex}
\input{src/frames-shell/bash-functions.tex}
\input{src/frames-shell/bash-options.tex}
\input{src/frames-shell/bash-miscelanous.tex}

\subsection{Shell, Zsh - Z-Shell}

\input{src/frames-shell/zsh-files.tex}
\input{src/frames-shell/zsh-history-pushd.tex}
\input{src/frames-shell/zsh-completion.tex}
\input{src/frames-shell/zsh-aliases.tex}
\input{src/frames-shell/zsh-options.tex}

\subsection{Shell, Oh my Zsh}

\input{src/frames-shell/zsh-ohmyzsh.tex}
\input{src/frames-shell/zsh-plugins.tex}
\input{src/frames-shell/zsh-plugins-z-bash.tex}

\subsection{Shell, p10k}

\input{src/frames-shell/zsh-p10k.tex}
\input{src/frames-shell/zsh-p10k-custom.tex}

\subsection{Tilt}

\input{src/frames-tilt/tilt-intro.tex}
\input{src/frames-tilt/tilt-func-docker_build.tex}
\input{src/frames-tilt/tilt-func-k8s_deploy.tex}
\input{src/frames-tilt/tilt-func-others.tex}
